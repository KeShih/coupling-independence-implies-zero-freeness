import CI2ZF.HolantInstanceSeparator
import CI2ZF.HolantGeometry
...
theorem sum_W_subsetShellLaw_le {ι : Type*} [Fintype ι]
  ...
  calc
    ...
    _ ≤ W subsetHam μ ν :=
      CI2ZF.sum_W_le_W _ _ (fun _ _ _ => subsetHam_nonneg _ _)
...
theorem exists_low_ambient_shell (H : NormalizedInstance V E) (Γ : SimpleGraph E)
  ...
  obtain ⟨i, hi⟩ := CI2ZF.exists_low_W_shell
