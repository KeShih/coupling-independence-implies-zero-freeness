...
theorem high_girth_field_transfer
  ...
  obtain ⟨g, K, hg, _, hcouple⟩ := high_girth_coupling identity transfer Δ hΔ hq
...
theorem high_girth_residual_original_field_transfer
  ...
  obtain ⟨g, hg, θ, hθ, hθ1, hn⟩ := high_girth_field_transfer identity transfer Δ hΔ hq
...
theorem high_girth_original_field_transfer
  ...
  obtain ⟨g, hg, θ, hθ, hθ1, hn⟩ :=
    high_girth_residual_original_field_transfer identity transfer Δ hΔ hq
  refine ⟨g, hg, θ, hθ, hθ1, ?_⟩
