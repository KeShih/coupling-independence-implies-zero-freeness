import CI2ZF.Coupling.Vigoda.HardBaselineData
import CI2ZF.Coupling.Vigoda.HardRootCost
import CI2ZF.Coupling.Vigoda.HardMoveClassification
...
local instance baselinePartitionConfigDecEq : DecidableEq (V → C) := Classical.decEq _
