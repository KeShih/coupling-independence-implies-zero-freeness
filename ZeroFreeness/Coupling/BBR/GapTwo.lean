...
theorem `ZeroFreeness.Appendix.BBR.proposition_2_6_i_holds` is stated for
...
open ZeroFreeness.Appendix ZeroFreeness.Appendix.BBR ZeroFreeness.Appendix.Girth
