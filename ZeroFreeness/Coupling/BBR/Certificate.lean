import ZeroFreeness.Coupling.BBR.Weights
...
proved, in `ZeroFreeness.Coupling.BBR.Proposition26` and
`ZeroFreeness.Coupling.BBR.Theorem25`, and `literature` there supplies the bundle.
...
Proved as `literature` in `ZeroFreeness.Coupling.BBR.Proposition26`. -/
