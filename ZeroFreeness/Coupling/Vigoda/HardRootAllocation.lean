import ZeroFreeness.Coupling.Vigoda.HardConditionalCoupling
import ZeroFreeness.Coupling.Vigoda.RootComponentGeometry

/-! Root-component allocations with capacities derived from actual graph
geometry, actual feasibility, and actual transition probabilities. -/
namespace ZeroFreeness
open PottsCI PottsCI.Vigoda PottsCI.FinDist
open RootComponentGeometry VigodaArithmetic
