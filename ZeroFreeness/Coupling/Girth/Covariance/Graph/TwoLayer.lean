...
import ZeroFreeness.Coupling.Girth.Geometry
import ZeroFreeness.Coupling.Girth.Covariance.Insertion.Graph
...
theorem second_mem_shell (w : Second I) : some w.val ∈ ZeroFreeness.BFS.shell I.graph none 2 := by
  exact ZeroFreeness.BFS.mem_shell.mpr ⟨(first_adj I (owner I w)).reachable.trans (owner_adj I w).reachable,
    second_distance I w⟩
