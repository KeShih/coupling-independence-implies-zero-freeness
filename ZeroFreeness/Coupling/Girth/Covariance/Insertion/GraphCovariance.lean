import ZeroFreeness.Coupling.Girth.Covariance.Insertion.GraphCoordinates
...
open PottsCI
open ZeroFreeness.Potts.Separator
...
theorem expect_model_shell (c₀ : C) (hZ : 0 < I.partition x) (f : (S → C) → ℝ) :
  ...
  rw [InsertionBalance.expect_shellLaw, law, ZeroFreeness.expectReal_mapLaw]
  rfl
