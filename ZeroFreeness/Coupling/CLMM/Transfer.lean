import ZeroFreeness.Coupling.Girth.Tree.Levels
import ZeroFreeness.Coupling.CLMM.Ambient
import ZeroFreeness.Coupling.CLMM.SphereCoupling
...
`ZeroFreeness.Coupling.CLMM.SphereEstimate`, and CLMM Lemma 5.13 is proved in
`ZeroFreeness.Coupling.CLMM.SphereCoupling`. The choice of both radii,
...
in `ZeroFreeness.Coupling.CLMM.SphereEstimate`. All members here have positive
