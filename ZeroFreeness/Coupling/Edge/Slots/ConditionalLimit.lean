...
namespace ZeroFreeness.Appendix.Edge.EndpointGeometry
...
theorem approxRootExcludedColourLaw_W_le [Nonempty C] (g : EndpointGeometry V E)
  ...
  have heq : ZeroFreeness.mapLaw (I.validLaw (fun _ => ∅) hB) colourProjection =
...
end ZeroFreeness.Appendix.Edge.EndpointGeometry
