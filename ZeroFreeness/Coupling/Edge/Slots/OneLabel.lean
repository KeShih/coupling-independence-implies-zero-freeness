...
lifted laws `ν_{F,B}` of `ZeroFreeness/Coupling/Edge/Slots/SlotLift.lean`
...
namespace ZeroFreeness.Appendix.Edge.OneLabel
open PottsCI PottsCI.FinDist ZeroFreeness.Appendix.Edge Filter Topology
...
end ZeroFreeness.Appendix.Edge.OneLabel
