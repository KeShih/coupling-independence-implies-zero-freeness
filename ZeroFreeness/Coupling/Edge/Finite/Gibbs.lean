...
lemma mapLaw_join_w (e : E) (a : A) (μ : FinDist ({f : E // f ≠ e} → A)) (σ : E → A) :
    (ZeroFreeness.mapLaw μ (joinConfig e a)).w σ = if σ e = a then μ.w (restrictConfig e σ) else 0 := by
...
theorem conditional_gibbs_coordinate (I : FiniteSystem V E A L) (B : Boundary V L)
    ...
    conditional (I.gibbs B hZ) (fun σ => σ e = a) =
      ZeroFreeness.mapLaw ((I.remove e).gibbs (I.pinBoundary B e a) hZp) (joinConfig e a) := by
