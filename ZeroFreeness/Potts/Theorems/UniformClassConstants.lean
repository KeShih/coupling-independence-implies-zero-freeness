...
import ZeroFreeness.Potts.Transfer.FamilyUniformTransfer
...
As in `ZeroFreeness/LeeYang/GraphClassUniform.lean` (`ciUnionClass`), we apply the
...
open PottsCI Set Metric ZeroFreeness.Potts
